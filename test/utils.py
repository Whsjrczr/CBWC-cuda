...
def show_time(func, a, gamma, beta, type='cppcuda', ntest=10, device="cuda:0"):
    """
    Parameters:
    ...
    for _ in range(ntest):
        time.sleep(1) # test failed, just in case
...
def show_time_backward(func, grad_output, normalized, gamma, std_eps, ntest=10, device="cuda:0"):
    """
    Parameters:
    - func: ``PyTorch`` Class or self implemented function
