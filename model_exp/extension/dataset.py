...
dataset_list = ['mnist', 'mnist_RandomLabel', 'cifar10_RandomLabel', 'fashion-mnist', 'cifar10', 'ImageNet',
                'folder', 'cifar100']
...
def get_dataset_loader(args: argparse.Namespace, transforms=None, target_transform=None, train=True, use_cuda=True):
    ...
    if args.dataset == 'mnist':
        ...
        if len(args.im_size) == 0:
            args.im_size = (3, 32, 32)
        args.dataset_classes = 10
        dataset = torchvision.datasets.CIFAR100(root, train, transforms, target_transform, download=True)
