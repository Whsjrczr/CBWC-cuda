...
class MNIST:
    def __init__(self):
        ...
        self.model_name = self.cfg.dataset + '_' + self.cfg.arch + '_d' + str(self.cfg.depth) + '_w' \
                          + str(self.cfg.width)+ '_' + ext.normalization.setting(self.cfg) + '_oo' + str(self.cfg.optimizer)
    ...
    def add_arguments(self):
        ...
        model_names = ['MLP', 'LinearModel', 'Linear']
        ...
        parser.set_defaults(dataset='cifar10_RandomLabel', workers=1, batch_size=[64, 1000])
